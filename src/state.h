...
public:
  static void init() {  
    ...
    for(uint8_t i = 0; i < ServoPin::Name::COUNT; i++){
      ...
      _statePacket.servoAngle[name] = ServoPin::initAngle(name);
      _nextAngle[name] = ServoPin::initAngle(name);
    }
  ...
  static void setServoAngle(ServoPin::Name n, uint8_t val) { 
    if(val != _nextAngle[n]){
      _nextAngle[n] = val;
  ...
  static void printState(){
    ...
    Serial.print("SRV1=");
    Serial.print(State::getServoAngle(ServoPin::Name::SRV1));
    Serial.print(" | SRV2=");
    Serial.print(State::getServoAngle(ServoPin::Name::SRV2));
    Serial.print(" | SRV3=");
    Serial.print(State::getServoAngle(ServoPin::Name::SRV3));
    Serial.print(" | SRV4=");
    Serial.print(State::getServoAngle(ServoPin::Name::SRV4));
...
private:
  ...
  static uint8_t _nextAngle[ServoPin::Name::COUNT];
...
inline uint8_t State::_nextAngle[ServoPin::Name::COUNT];